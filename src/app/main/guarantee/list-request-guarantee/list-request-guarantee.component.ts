...
@Component({
  selector: 'app-list-request-guarantee',
  templateUrl: './list-request-guarantee.component.html',
  styleUrls: ['./list-request-guarantee.component.scss'],
  animations: fuseAnimations
})
export class ListRequestGuaranteeComponent implements OnInit {
  ...
  private getAllGuarantees() {
    ...
    this.apollo
      ...
      .valueChanges.map((result: any) => result.data.branchOfficeById.guaranteesRequest)
      .subscribe(data => {
  ...
  openDialog(): void {
    ...
    this.dialogRef.afterClosed()
        .subscribe(response => {
          if(response && response.createGuaranteeRequest) {
            this.dataSource.data.push(response.createGuaranteeRequest);
            this.dataSource.data = this.dataSource.data.slice();

            // Show the success message
            this._matSnackBar.open('Solicitud Guardado', 'OK', {

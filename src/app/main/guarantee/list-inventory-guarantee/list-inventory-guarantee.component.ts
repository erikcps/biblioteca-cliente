...
@Component({
  selector: 'app-list-inventory-guarantee',
  templateUrl: './list-inventory-guarantee.component.html',
  styleUrls: ['./list-inventory-guarantee.component.scss'],
  animations: fuseAnimations
})
export class ListInventoryGuaranteeComponent implements OnInit {
  ...
  private getAllGuarantees() {
    ...
    this.apollo
      ...
      .valueChanges.map((result: any) => result.data.branchOfficeById.guaranteesInventory)
      .subscribe(data => {
  ...
  openDialog(): void {
    ...
    this.dialogRef.afterClosed()
        .subscribe(response => {
          if(response && response.createGuaranteeInventory) {
            this.dataSource.data.push(response.createGuaranteeInventory);
            this.dataSource.data = this.dataSource.data.slice();

            // Show the success message
            this._matSnackBar.open('Prestamo Guaradado', 'OK', {

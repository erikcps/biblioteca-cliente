...
@Component({
  selector: 'app-list-sent-guarantee',
  templateUrl: './list-sent-guarantee.component.html',
  styleUrls: ['./list-sent-guarantee.component.scss'],
  animations: fuseAnimations
})
export class ListSentGuaranteeComponent implements OnInit {
  ...
  private getAllGuarantees() {
    ...
    this.apollo
      ...
      .valueChanges.map((result: any) => result.data.branchOfficeById.guaranteesSent)
      .subscribe(data => {
        console.log(data);
  ...
  openDialog(): void {
    ...
    this.dialogRef.afterClosed()
        .subscribe(response => {
          if(response && response.createGuaranteeSent) {
            this.dataSource.data.push(response.createGuaranteeSent);
            this.dataSource.data = this.dataSource.data.slice();

            // Show the success message
            this._matSnackBar.open('Envio Guardado', 'OK', {
